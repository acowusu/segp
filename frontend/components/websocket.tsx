...
function Websocket() {
    ...
    useEffect(() => {
        ...
        const server = new WebSocket('ws://34.83.91.19:80');

        // Connection opened
        server.addEventListener('open', (event) => {
            server.send('What is the weather like in San Francisco?');
        });
        ...
        // Update the WebSocket connection when the component mounts
        setWs(server);
