...
llm = LLM(model_id="TheBloke/Mistral-7B-Instruct-v0.1-AWQ", quantization='awq',
...
@app.post("/image")
async def login(prompt: Annotated[str, Form()], width: Annotated[str, Form()],  height: Annotated[str, Form()]):
