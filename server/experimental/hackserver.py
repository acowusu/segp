...
def gen_res():
    ...
    response = client.chat.completions.create(
        model="gpt-3.5-turbo",
        messages=[
            {"role": "system", "content": "You are a helpful language tutor! please help assist your students with their leearning. Today, the topic of discussion will be" + data["topic"]},
