...
import Modal from '../components/ui/screenmodals';
...
export const ScriptEditor: React.FC = () => {
  ...
  return (
    <div>
      ...
      {/* Modals */}
      <Modal modalVisible={generating}>
        <div className='p-16 flex flex-col h-full items-center justify-center gap-32 text-4xl font-bold'>
          <h1>
